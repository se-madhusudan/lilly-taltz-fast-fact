<template>
  ...
  export default {
    ...
    data() {
      return {
        // ReferenceList: [
        //   "Davies MJ, Aroda VR, Collins BS, et al. Management of hyperglycemia in type 2 diabetes, 2022. A consensus report by the American Diabetes Association (ADA) and the European Association for the Study of Diabetes (EASD). <i>Diabetes Care.</i> 2022;45(11):2753-2786.",
        ...
        //   "Look AHEAD Research Group. Cardiovascular effects of intensive lifestyle intervention in type 2 diabetes [published correction appears in N Engl J Med. 2014;370(19):1866]. <i>N Engl J Med.</i> 2013;369(2):145-154.",
        ...
        //   "Apovian C, Okemah J, O&rsquo;Neil P. Body weight considerations in the management of type 2 diabetes. <i>Adv Ther.</i> 2019:36:44-58.",
